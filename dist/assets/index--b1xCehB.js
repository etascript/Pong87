...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:pr,depthTest:!1,depthWrite:!1})}function bh(){return new xr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Df(),fragmentShader:`
		...
		`,blending:pr,depthTest:!1,depthWrite:!1})}function Th(){return new xr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Df(),fragmentShader:`
	...
	`}function eE(n){let e=new WeakMap,t=null;function i(a){if(a&&a.isTexture){const c=a.mapping,f=c===du||c===hu,d=c===Ns||c===Fs;if(f||d){let u=e.get(a);const p=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==p)return t===null&&(t=new Eh(n)),u=f?t.fromEquirectangular(a,u):t.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),u.texture;if(u!==void 0)return u.texture;{const m=a.image;return f&&m&&m.height>0||d&&m&&r(m)?(t===null&&(t=new Eh(n)),u=f?t.fromEquirectangular(a):t.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),a.addEventListener("dispose",s),u.texture):null}}}return a}function r(a){let c=0;const f=6;for(let d=0;d<f;d++)a[d]!==void 0&&c++;return c===f}function s(a){const c=a.target;c.removeEventListener("dispose",s);const f=e.get(c);f!==void 0&&(e.delete(c),f.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:o}}function tE(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let r;switch(i){case"WEBGL_depth_texture":r=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=n.getExtension(i)}return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const r=t(i);return r===null&&ws("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function nE(n,e,t,i){const r={},s=new WeakMap;function o(u){const p=u.target;p.index!==null&&e.remove(p.index);for(const x in p.attributes)e.remove(p.attributes[x]);p.removeEventListener("dispose",o),delete r[p.id];const m=s.get(p);m&&(e.remove(m),s.delete(p)),i.releaseStatesOfGeometry(p),p.isInstancedBufferGeometry===!0&&delete p._maxInstanceCount,t.memory.geometries--}function a(u,p){return r[p.id]===!0||(p.addEventListener("dispose",o),r[p.id]=!0,t.memory.geometries++),p}function c(u){const p=u.attributes;for(const m in p)e.update(p[m],n.ARRAY_BUFFER)}function f(u){const p=[],m=u.index,x=u.attributes.position;let y=0;if(m!==null){const I=m.array;y=m.version;for(let R=0,T=I.length;R<T;R+=3){const U=I[R+0],B=I[R+1],k=I[R+2];p.push(U,B,B,k,k,U)}}else if(x!==void 0){const I=x.array;y=x.version;for(let R=0,T=I.length/3-1;R<T;R+=3){const U=R+0,B=R+1,k=R+2;p.push(U,B,B,k,k,U)}}else return;const v=new(Nm(p)?Vm:zm)(p,1);v.version=y;const g=s.get(u);g&&e.remove(g),s.set(u,v)}function d(u){const p=s.get(u);if(p){const m=u.index;m!==null&&p.version<m.version&&f(u)}else f(u);return s.get(u)}return{get:a,update:c,getWireframeAttribute:d}}function iE(n,e,t){let i;function r(p){i=p}let s,o;function a(p){s=p.type,o=p.bytesPerElement}function c(p,m){n.drawElements(i,m,s,p*o),t.update(m,i,1)}function f(p,m,x){x!==0&&(n.drawElementsInstanced(i,m,s,p*o,x),t.update(m,i,x))}function d(p,m,x){if(x===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,m,0,s,p,0,x);let v=0;for(let g=0;g<x;g++)v+=m[g];t.update(v,i,1)}function u(p,m,x,y){if(x===0)return;const v=e.get("WEBGL_multi_draw");if(v===null)for(let g=0;g<p.length;g++)f(p[g]/o,m[g],y[g]);else{v.multiDrawElementsInstancedWEBGL(i,m,0,s,p,0,y,0,x);let g=0;for(let I=0;I<x;I++)g+=m[I]*y[I];t.update(g,i,1)}}this.setMode=r,this.setIndex=a,this.render=c,this.renderInstances=f,this.renderMultiDraw=d,this.renderMultiDrawInstances=u}function rE(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(t.calls++,o){case n.TRIANGLES:t.triangles+=a*(s/3);break;case n.LINES:t.lines+=a*(s/2);break;case n.LINE_STRIP:t.lines+=a*(s-1);break;case n.LINE_LOOP:t.lines+=a*s;break;case n.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function sE(n,e,t){const i=new WeakMap,r=new qt;function s(o,a,c){const f=o.morphTargetInfluences,d=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=d!==void 0?d.length:0;let p=i.get(a);if(p===void 0||p.count!==u){let C=function(){J.dispose(),i.delete(a),a.removeEventListener("dispose",C)};var m=C;p!==void 0&&p.texture.dispose();const x=a.morphAttributes.position!==void 0,y=a.morphAttributes.normal!==void 0,v=a.morphAttributes.color!==void 0,g=a.morphAttributes.position||[],I=a.morphAttributes.normal||[],R=a.morphAttributes.color||[];let T=0;x===!0&&(T=1),y===!0&&(T=2),v===!0&&(T=3);let U=a.attributes.position.count*T,B=1;U>e.maxTextureSize&&(B=Math.ceil(U/e.maxTextureSize),U=e.maxTextureSize);const k=new Float32Array(U*B*4*u),J=new Fm(k,U,B,u);J.type=zi,J.needsUpdate=!0;const P=T*4;for(let N=0;N<u;N++){const ye=g[N],D=I[N],W=R[N],$=U*B*4*N;for(let F=0;F<ye.count;F++){const V=F*P;x===!0&&(r.fromBufferAttribute(ye,F),k[$+V+0]=r.x,k[$+V+1]=r.y,k[$+V+2]=r.z,k[$+V+3]=0),y===!0&&(r.fromBufferAttribute(D,F),k[$+V+4]=r.x,k[$+V+5]=r.y,k[$+V+6]=r.z,k[$+V+7]=0),v===!0&&(r.fromBufferAttribute(W,F),k[$+V+8]=r.x,k[$+V+9]=r.y,k[$+V+10]=r.z,k[$+V+11]=W.itemSize===4?r.w:1)}}p={count:u,texture:J,size:new wt(U,B)},i.set(a,p),a.addEventListener("dispose",C)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(n,"morphTexture",o.morphTexture,t);else{let x=0;for(let v=0;v<f.length;v++)x+=f[v];const y=a.morphTargetsRelative?1:1-x;c.getUniforms().setValue(n,"morphTargetBaseInfluence",y),c.getUniforms().setValue(n,"morphTargetInfluences",f)}c.getUniforms().setValue(n,"morphTargetsTexture",p.texture,t),c.getUniforms().setValue(n,"morphTargetsTextureSize",p.size)}return{update:s}}function oE(n,e,t,i){let r=new WeakMap;function s(c){const f=i.render.frame,d=c.geometry,u=e.get(c,d);if(r.get(u)!==f&&(e.update(u),r.set(u,f)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),r.get(c)!==f&&(t.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,n.ARRAY_BUFFER),r.set(c,f))),c.isSkinnedMesh){const p=c.skeleton;r.get(p)!==f&&(p.update(),r.set(p,f))}return u}function o(){r=new WeakMap}function a(c){const f=c.target;f.removeEventListener("dispose",a),t.remove(f.instanceMatrix),f.instanceColor!==null&&t.remove(f.instanceColor)}return{update:s,dispose:o}}const Ym=new Pn,Ah=new Xm(1,1),Km=new Fm,Jm=new Nv,Zm=new Wm,wh=[],Rh=[],Ch=new Float32Array(16),Ph=new Float32Array(9),Ih=new Float32Array(4);function $s(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=wh[r];if(s===void 0&&(s=new Float32Array(r),wh[r]=s),e!==0){i.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,n[o].toArray(s,a)}return s}function en(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function tn(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function Tl(n,e){let t=Rh[e];t===void 0&&(t=new Int32Array(e),Rh[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function aE(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function lE(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(en(t,e))return;n.uniform2fv(this.addr,e),tn(t,e)}}function cE(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(en(t,e))return;n.uniform3fv(this.addr,e),tn(t,e)}}function uE(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(en(t,e))return;n.uniform4fv(this.addr,e),tn(t,e)}}function fE(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(en(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),tn(t,e)}else{if(en(t,i))return;Ih.set(i),n.uniformMatrix2fv(this.addr,!1,Ih),tn(t,i)}}function dE(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(en(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),tn(t,e)}else{if(en(t,i))return;Ph.set(i),n.uniformMatrix3fv(this.addr,!1,Ph),tn(t,i)}}function hE(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(en(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),tn(t,e)}else{if(en(t,i))return;Ch.set(i),n.uniformMatrix4fv(this.addr,!1,Ch),tn(t,i)}}function pE(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function mE(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(en(t,e))return;n.uniform2iv(this.addr,e),tn(t,e)}}function gE(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(en(t,e))return;n.uniform3iv(this.addr,e),tn(t,e)}}function _E(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(en(t,e))return;n.uniform4iv(this.addr,e),tn(t,e)}}function vE(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function xE(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(en(t,e))return;n.uniform2uiv(this.addr,e),tn(t,e)}}function yE(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(en(t,e))return;n.uniform3uiv(this.addr,e),tn(t,e)}}function SE(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(en(t,e))return;n.uniform4uiv(this.addr,e),tn(t,e)}}function EE(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(Ah.compareFunction=Um,s=Ah):s=Ym,t.setTexture2D(e||s,r)}function ME(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||Jm,r)}function bE(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||Zm,r)}function TE(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||Km,r)}function AE(n){switch(n){case 5126:return aE;case 35664:return lE;case 35665:return cE;case 35666:return uE;case 35674:return fE;case 35675:return dE;case 35676:return hE;case 5124:case 35670:return pE;case 35667:case 35671:return mE;case 35668:case 35672:return gE;case 35669:case 35673:return _E;case 5125:return vE;case 36294:return xE;case 36295:return yE;case 36296:return SE;case 35678:case 36198:case 36298:case 36306:case 35682:return EE;case 35679:case 36299:case 36307:return ME;case 35680:case 36300:case 36308:case 36293:return bE;case 36289:case 36303:case 36311:case 36292:return TE}}function wE(n,e){n.uniform1fv(this.addr,e)}function RE(n,e){const t=$s(e,this.size,2);n.uniform2fv(this.addr,t)}function CE(n,e){const t=$s(e,this.size,3);n.uniform3fv(this.addr,t)}function PE(n,e){const t=$s(e,this.size,4);n.uniform4fv(this.addr,t)}function IE(n,e){const t=$s(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function DE(n,e){const t=$s(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function LE(n,e){const t=$s(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function OE(n,e){n.uniform1iv(this.addr,e)}function UE(n,e){n.uniform2iv(this.addr,e)}function NE(n,e){n.uniform3iv(this.addr,e)}function FE(n,e){n.uniform4iv(this.addr,e)}function BE(n,e){n.uniform1uiv(this.addr,e)}function kE(n,e){n.uniform2uiv(this.addr,e)}function zE(n,e){n.uniform3uiv(this.addr,e)}function VE(n,e){n.uniform4uiv(this.addr,e)}function HE(n,e,t){const i=this.cache,r=e.length,s=Tl(t,r);en(i,s)||(n.uniform1iv(this.addr,s),tn(i,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||Ym,s[o])}function GE(n,e,t){const i=this.cache,r=e.length,s=Tl(t,r);en(i,s)||(n.uniform1iv(this.addr,s),tn(i,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||Jm,s[o])}function WE(n,e,t){const i=this.cache,r=e.length,s=Tl(t,r);en(i,s)||(n.uniform1iv(this.addr,s),tn(i,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||Zm,s[o])}function $E(n,e,t){const i=this.cache,r=e.length,s=Tl(t,r);en(i,s)||(n.uniform1iv(this.addr,s),tn(i,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||Km,s[o])}function XE(n){switch(n){case 5126:return wE;case 35664:return RE;case 35665:return CE;case 35666:return PE;case 35674:return IE;case 35675:return DE;case 35676:return LE;case 5124:case 35670:return OE;case 35667:case 35671:return UE;case 35668:case 35672:return NE;case 35669:case 35673:return FE;case 5125:return BE;case 36294:return kE;case 36295:return zE;case 36296:return VE;case 35678:case 36198:case 36298:case 36306:case 35682:return HE;case 35679:case 36299:case 36307:return GE;case 35680:case 36300:case 36308:case 36293:return WE;case 36289:case 36303:case 36311:case 36292:return $E}}class qE{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=AE(t.type)}}class jE{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=XE(t.type)}}class YE{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],i)}}}const Fc=/(\w+)(\])?(\[|\.)?/g;function Dh(n,e){n.seq.push(e),n.map[e.id]=e}function KE(n,e,t){const i=n.name,r=i.length;for(Fc.lastIndex=0;;){const s=Fc.exec(i),o=Fc.lastIndex;let a=s[1];const c=s[2]==="]",f=s[3];if(c&&(a=a|0),f===void 0||f==="["&&o+2===r){Dh(t,f===void 0?new qE(a,n,e):new jE(a,n,e));break}else{let u=t.map[a];u===void 0&&(u=new YE(a),Dh(t,u)),t=u}}}class za{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);KE(s,o,this)}}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],c=i[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&i.push(o)}return i}}function Lh(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const JE=37297;let ZE=0;function QE(n,e){const t=n.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;i.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return i.join(`
`)}const Oh=new ft;function eM(n){Mt._getMatrix(Oh,Mt.workingColorSpace,n);const e=`mat3( ${Oh.elements.map(t=>t.toFixed(4))} )`;switch(Mt.getTransfer(n)){case Ka:return[e,"LinearTransferOETF"];case Pt:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function Uh(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),s=(n.getShaderInfoLog(e)||"").trim();if(i&&s==="")return"";const o=/ERROR: 0:(\d+)/.exec(s);if(o){const a=parseInt(o[1]);return t.toUpperCase()+`

`+s+`

`+QE(n.getShaderSource(e),a)}else return s}function tM(n,e){const t=eM(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function nM(n,e){let t;switch(e){case cv:t="Linear";break;case uv:t="Reinhard";break;case fv:t="Cineon";break;case dv:t="ACESFilmic";break;case pv:t="AgX";break;case mv:t="Neutral";break;case hv:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ra=new le;function iM(){Mt.getLuminanceCoefficients(Ra);const n=Ra.x.toFixed(4),e=Ra.y.toFixed(4),t=Ra.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function rM(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(fo).join(`
`)}function sM(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function oM(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(e,r),o=s.name;let a=1;s.type===n.FLOAT_MAT2&&(a=2),s.type===n.FLOAT_MAT3&&(a=3),s.type===n.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:n.getAttribLocation(e,o),locationSize:a}}return t}function fo(n){return n!==""}function Nh(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Fh(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const aM=/^[ \t]*#include +<([\w\d./]+)>/gm;function Gu(n){return n.replace(aM,cM)}const lM=new Map;function cM(n,e){let t=pt[e];if(t===void 0){const i=lM.get(e);if(i!==void 0)t=pt[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return Gu(t)}const uM=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Bh(n){return n.replace(uM,fM)}function fM(n,e,t,i){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function kh(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}function dM(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===bm?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===H_?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Li&&(e="SHADOWMAP_TYPE_VSM"),e}function hM(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Ns:case Fs:e="ENVMAP_TYPE_CUBE";break;case yl:e="ENVMAP_TYPE_CUBE_UV";break}return e}function pM(n){let e="ENVMAP_MODE_REFLECTION";return n.envMap&&n.envMapMode===Fs&&(e="ENVMAP_MODE_REFRACTION"),e}function mM(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Tm:e="ENVMAP_BLENDING_MULTIPLY";break;case av:e="ENVMAP_BLENDING_MIX";break;case lv:e="ENVMAP_BLENDING_ADD";break}return e}function gM(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function _M(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=dM(t),f=hM(t),d=pM(t),u=mM(t),p=gM(t),m=rM(t),x=sM(s),y=r.createProgram();let v,g,I=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
    ...
    `}).join(""),Cw.innerHTML=pe.seats.map((s,o)=>`
  ...
  `).join(""),Iw.innerHTML=fw(pe).slice(0,3).map((s,o)=>`
  ...
  `).join("")}function eR(){if(!It||!bn||pe.phase!=="results")return;const n=pe.seats.map(e=>`${e.id}:${e.score}:${e.lives}`).join("|");!n||n===df||(df=n,YA(It,pe).catch(Zi))}function jo(n){Gs=n,g0.textContent=Gs?">":"II",Hi.clear(),$i()}function fd(n=!1){if(bn||!Qt)return;const e=performance.now();!n&&e-bp<33||(bp=e,Qt.send("input",{paddle:Er}))}function Gl(n,e=!1){Er=cn(n,0,1),fd(e)}function tR(){if(bn){const n=pe.seats.find(e=>e.id===oi);n&&n.lives>0&&(n.charge=!0);return}Qt?.send("input",{charge:!0})}function nR(n){const e=si.getBoundingClientRect();Gl((n-e.left)/e.width)}function T0(n,e,t){es=n,ff=e,_0=Er,ad=!1,t.setPointerCapture(n)}function A0(n,e){Math.abs(n-ff)>4&&(ad=!0);const t=window.innerWidth<720?1.25:1,i=(n-ff)/Math.max(1,e)*t;Gl(_0+i)}function Wl(n,e){es===n&&(es=null,e.hasPointerCapture(n)&&e.releasePointerCapture(n))}si.addEventListener("pointerdown",n=>{T0(n.pointerId,n.clientX,si)});si.addEventListener("pointermove",n=>{es===n.pointerId&&A0(n.clientX,si.getBoundingClientRect().width)});si.addEventListener("click",n=>{ad||nR(n.clientX)});si.addEventListener("pointerup",n=>Wl(n.pointerId,si));si.addEventListener("pointercancel",n=>Wl(n.pointerId,si));si.addEventListener("lostpointercapture",()=>{es=null});Ki.addEventListener("pointerdown",n=>{Do.classList.contains("hidden")&&T0(n.pointerId,n.clientX,Ki)});Ki.addEventListener("pointermove",n=>{es===n.pointerId&&A0(n.clientX,window.innerWidth*.72)});Ki.addEventListener("pointerup",n=>Wl(n.pointerId,Ki));Ki.addEventListener("pointercancel",n=>Wl(n.pointerId,Ki));Ki.addEventListener("lostpointercapture",()=>{es=null});function w0(){const n=Hi.has("ArrowLeft")||Hi.has("KeyA"),e=Hi.has("ArrowRight")||Hi.has("KeyD");return Number(e)-Number(n)}function iR(n){return n instanceof HTMLInputElement||n instanceof HTMLSelectElement||n instanceof HTMLTextAreaElement}window.addEventListener("keydown",n=>{if(n.code==="Escape"&&bn&&(pe.phase==="playing"||pe.phase==="countdown")){n.preventDefault(),jo(!Gs);return}if(!iR(n.target)&&["ArrowLeft","ArrowRight","KeyA","KeyD"].includes(n.code)){n.preventDefault(),Hi.add(n.code);const e=w0();e!==0&&Gl(Er+e*.045,!0)}n.code==="Space"&&!n.repeat&&(n.preventDefault(),tR())});window.addEventListener("keyup",n=>{["ArrowLeft","ArrowRight","KeyA","KeyD"].includes(n.code)&&Hi.delete(n.code)});Ow.addEventListener("click",()=>Ks("single"));Uw.addEventListener("click",()=>Ks("multi"));Nw.addEventListener("click",()=>qo("settings"));Fw.addEventListener("click",()=>qo("about"));Bw.addEventListener("click",()=>qo("exit"));kw.forEach(n=>n.addEventListener("click",()=>qo("main")));Gw.addEventListener("click",()=>ld().catch(Zi));af.addEventListener("change",()=>{an={...an,language:af.value==="en"?"en":"es"},ed(an),E0()});lf.addEventListener("input",()=>{an={...an,musicVolume:cn(Number(lf.value),0,100)},p0.textContent=`${an.musicVolume}%`,ed(an)});cf.addEventListener("input",()=>{an={...an,sfxVolume:cn(Number(cf.value),0,100)},m0.textContent=`${an.sfxVolume}%`,ed(an)});td.addEventListener("change",S0);fl.addEventListener("change",Ys);of.addEventListener("change",Ys);zw.addEventListener("click",()=>M0().catch(Zi));Vw.addEventListener("click",()=>Zw().catch(Zi));Hw.addEventListener("click",()=>cd().catch(Zi));Sr.addEventListener("click",()=>{if(bn){cd().catch(Zi);return}const n=pe.seats.find(e=>e.id===oi);Qt?.send("input",{ready:!n?.ready})});g0.addEventListener("click",()=>{jo(!Gs)});nd.addEventListener("click",()=>ld().catch(Zi));$w.addEventListener("click",()=>jo(!1));Xw.addEventListener("click",()=>ld().catch(Zi));function Zi(n){Hs.textContent=n instanceof Error?n.message:Ut("errorConnection"),It&&i0(It,"error.client",{message:Hs.textContent}).catch(()=>{})}function rR(n,e){const t={sides:n,phase:"countdown",lastEvent:Ut("offlineEvent"),round:1,countdown:.9,remainingTime:e.matchTimeSeconds,matchTimeSeconds:e.matchTimeSeconds,livesPerPlayer:e.lives,lastTouchEdge:-1,mode:e.mode,ball:{x:0,y:0,vx:0,vy:0},balls:[],chargedBy:-1,obstacles:[],seats:Array.from({length:n},(r,s)=>({id:s===0?"offline-human":`bot-${s}`,name:s===0?Bl.value.trim().slice(0,16)||Ut("playerFallback"):`${Ut("botName")} ${s}`,edgeIndex:s,paddle:.5,paddleVelocity:0,lives:e.lives,score:0,charge:!1,ready:!0,connected:!0}))},i=dd(-1,n);return t.ball={x:i.x,y:i.y,vx:i.vx,vy:i.vy},t.balls=[i],Ls=0,Oo=0,t}function dd(n=-1,e=pe.sides||Mr,t=0){const i=js(ns(e),br(e,ai)),r=n>=0?Fl(n,e):-1,o=(r>=0?Math.atan2(-i[r].inward.y,-i[r].inward.x):e===2?Math.random()<.5?0:Math.PI:Math.random()*Math.PI*2)+(Math.random()-.5)*.65,a=sw(e,pe.balls?.length??0,t);return{id:`local-ball-${x0++}`,x:0,y:0,vx:Math.cos(o)*a,vy:Math.sin(o)*a,lastTouchEdge:-1,chargedBy:-1,age:0,hitCount:0}}function pf(n,e=0){n.hitCount+=1;const t=Math.hypot(n.vx,n.vy)||s0,i=rw(n.hitCount,pe.sides)+e;n.vx=n.vx/t*i,n.vy=n.vy/t*i}function sR(n){if(!bn||pe.phase==="lobby")return;if(pe.phase==="countdown"){pe.countdown-=n,pe.countdown<=0&&(pe.phase="playing",pe.lastEvent=Ut("offlineEvent")),$i();return}if(Oo+=n,lR(n),oR(n),pe.matchTimeSeconds>0&&(pe.remainingTime=Math.max(0,pe.remainingTime-n),pe.remainingTime<=0)){aR(),$i();return}const e=l0(pe.sides,Oo);Ls+=n,pe.balls.length<e&&Ls>=Qf&&(pe.balls.push(dd()),pe.lastEvent="Nueva esfera",Ls=0);for(let t=pe.balls.length-1;t>=0;t-=1){const i=pe.balls[t];i.age+=n,i.x+=i.vx*n,i.y+=i.vy*n,uR(i),fR(i,t)}R0(),$i()}function oR(n){if(pe.obstacles.forEach(e=>{e.angle+=e.spin*n}),bs>0){bs-=n,bs<=0&&(pe.obstacles=Rp(pe.sides),bs=wp());return}$a-=n,$a<=0&&(pe.obstacles=Rp(pe.sides),bs=wp(),$a=0)}function aR(){const n=pe.seats.filter(i=>i.connected),e=Math.max(...n.map(i=>i.score),0),t=n.filter(i=>i.score===e);pe.phase="results",pe.obstacles=[],pe.chargedBy=-1,pe.ball={x:0,y:0,vx:0,vy:0},pe.balls=[],pe.lastEvent=t.length===1?`${t[0].name} gana por tiempo`:"Empate por tiempo"}function lR(n){const e=js(ns(pe.sides),br(pe.sides,ai));pe.seats.forEach(t=>{if(t.id===oi||pe.mode==="elimination"&&t.lives<=0)return;const i=e[Fl(t.edgeIndex,pe.sides)],s=hf().map(R=>({ball:R,prediction:cR(i,{x:R.x,y:R.y},{x:R.vx,y:R.vy})})).filter(R=>R.prediction).sort((R,T)=>(R.prediction?.time??99)-(T.prediction?.time??99))[0],o=s?.prediction??null,a=s?.ball??hf()[0]??pe.ball,c=performance.now()*.001,f=.5+t.edgeIndex*37%5*.08,d=.5+Math.sin(c*(.85+f)+t.edgeIndex*2.1)*.26,u=jr({x:a.vx,y:a.vy},i.tangent),p=cn(u/12,-.14,.14),m=o?cn(1.25-o.time,0,1):0,x=Math.sin(c*3.1+t.edgeIndex*1.7)*(.11-m*.045),y=o?o.t+p*m+x:d,v=cn(y,.08,.92),g=n*(.56+m*1.28+f*.18),I=t.paddle;t.paddle+=cn(v-t.paddle,-g,g),t.paddleVelocity=(t.paddle-I)/Math.max(n,.001)})}function cR(n,e,t){const i=jr(t,n.inward);if(i>=-.001)return null;const r={x:e.x-n.a.x,y:e.y-n.a.y},s=jr(r,n.inward),o=(Gn-s)/i;if(o<0||o>2.5)return null;const a={x:e.x+t.x*o,y:e.y+t.y*o},c=jr({x:a.x-n.a.x,y:a.y-n.a.y},n.tangent);return{t:cn(c/n.length,0,1),time:o}}function uR(n){for(const e of pe.obstacles){const t=n.x-e.x,i=n.y-e.y,r=Math.hypot(t,i),s=e.radius+Gn;if(r>s)continue;const o=r>.001?{x:t/r,y:i/r}:{x:1,y:0},a=nf({x:n.vx,y:n.vy},o),c={x:-o.y,y:o.x};n.vx=a.x+c.x*e.spin*.55,n.vy=a.y+c.y*e.spin*.55,pf(n),n.x=e.x+o.x*(s+.05),n.y=e.y+o.y*(s+.05),n.chargedBy=-1,pe.lastEvent="Obstaculo desvio";return}}function fR(n,e){const t=js(ns(pe.sides),br(pe.sides,ai));for(let i=0;i<t.length;i+=1){const r=t[i],s={x:n.x-r.a.x,y:n.y-r.a.y},o=jr(s,r.inward);if(o>Gn)continue;const c=jr(s,r.tangent)/r.length;if(c<-.02||c>1.02)continue;const f=c0(i,pe.sides),d=f>=0?pe.seats[f]:void 0;if(!d){const g=nf({x:n.vx,y:n.vy},r.inward);n.vx=g.x,n.vy=g.y,pf(n),n.x+=r.inward.x*(Gn-o+.06),n.y+=r.inward.y*(Gn-o+.06),n.chargedBy=-1,pe.lastEvent=`Muro ${i+1} reboto`;return}const p=Zf/r.length/2,m=d.id===oi?Fi:d.paddle,x=pe.mode==="elimination"&&d.connected&&d.lives<=0,y=d.connected&&d.lives>0&&Math.abs(c-m)<=p;if(y||x){const g=nf({x:n.vx,y:n.vy},r.inward),I=y?cn((c-m)/p,-1,1):0,R=Math.sign(I)*Math.pow(Math.abs(I),.72)*3.7,T=d.id===oi?sd:d.paddleVelocity,U=y?-cn(T,-3.2,3.2)*1.25:0;n.vx=g.x+r.tangent.x*(R+U),n.vy=g.y+r.tangent.y*(R+U);const B=y&&d.charge;pf(n,B?2.3:0),n.x+=r.inward.x*(Gn-o+.06),n.y+=r.inward.y*(Gn-o+.06),y?(n.lastTouchEdge=d.edgeIndex,n.chargedBy=B?d.edgeIndex:-1,pe.lastTouchEdge=d.edgeIndex,pe.chargedBy=n.chargedBy,d.charge=!1,pe.lastEvent=`${d.name} bloqueo`):(n.chargedBy=-1,pe.lastEvent=`Muro ${d.edgeIndex+1} reboto`);return}if(pe.mode==="score"){const g=pe.seats[n.lastTouchEdge];g&&g.connected&&g.edgeIndex!==d.edgeIndex?(g.score+=1,pe.lastEvent=`${g.name} anota`,Hr=1):pe.lastEvent=`${d.name} fallo`}else d.lives=Math.max(0,d.lives-1),pe.lastEvent=d.lives===0?`${d.name} eliminado`:`${d.name} perdio una vida`;const v=pe.mode==="score"?pe.seats.filter(g=>g.connected):pe.seats.filter(g=>g.lives>0);if(pe.mode==="elimination"&&v.length<=1)pe.phase="results",pe.lastEvent=v[0]?`${v[0].name} gana`:"Ronda terminada",pe.balls=[];else{pe.round+=1;const g=Math.hypot(n.vx,n.vy);pe.balls.splice(e,1),pe.balls.length<l0(pe.sides,Oo)&&(pe.balls.push(dd(d.edgeIndex,pe.sides,g)),Ls=0)}R0();return}}function R0(){const n=pe.balls[0];if(!n){pe.ball={x:0,y:0,vx:0,vy:0},pe.lastTouchEdge=-1,pe.chargedBy=-1;return}pe.ball={x:n.x,y:n.y,vx:n.vx,vy:n.vy},pe.lastTouchEdge=n.lastTouchEdge,pe.chargedBy=n.chargedBy}function C0(n){const e=Math.min((n-Tp)/1e3,.1);Tp=n;const t=Yw();if(dl.rotation.z+=Kw(dl.rotation.z,t)*Math.min(1,e*16),!Gs){const i=w0();i!==0&&Gl(Er+i*e*1.85);const r=Fi;for(Fi+=(Er-Fi)*Math.min(1,e*18),sd=(Fi-r)/Math.max(e,.001),Dw.style.left=`${Fi*100}%`,Wa+=e;Wa>=Yc;)sR(Yc),Wa-=Yc;Hr=Math.max(0,Hr-e*2.8),h0.style.filter=Hr>0?`brightness(${1+Hr*.8}) saturate(${1+Hr*.5})`:"",Ew(zl,hf(),Vi,n),mw(rd,pe.obstacles,n);const s=js(ns(pe.sides),br(pe.sides,ai));Lo.children.forEach(o=>{const a=o,c=a.userData.playerIndex,f=a.userData.edgeIndex,d=s[f],u=pe.seats[c],p=pe.mode==="elimination"&&!!u?.connected&&(u?.lives??0)<=0,m=p?.5:u?.connected&&u.id===oi?Fi:u?.paddle??.5,x=u0(d,m);a.position.set(x.x+d.inward.x*(p?.05:.28),x.y+d.inward.y*(p?.05:.28),.45),a.rotation.z=d.angle,a.scale.x=p?d.length/Zf:1,a.scale.y=p?.32:u?.connected?1:.35;const y=a.material;y.opacity=p?.42:1})}kl.render(id,ur),requestAnimationFrame(C0)}window.addEventListener("resize",Vl);window.addEventListener("blur",()=>{Hi.clear(),fd(!0)});document.addEventListener("visibilitychange",()=>{document.hidden&&Hi.clear(),fd(!0)});y0(Mr);Vl();E0();S0();Qw().catch(Zi);requestAnimationFrame(C0);window.__THREE_GAME_DIAGNOSTICS__=()=>({renderer:kl.info.render,snapshot:pe,connected:!!Qt,mySessionId:oi,localPaddle:Fi,localPaddleTarget:Er,arcade:It});
